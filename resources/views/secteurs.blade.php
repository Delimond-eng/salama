...
<div
    ...
    <div class="mt-5 grid grid-cols-12 gap-6" id="App" v-cloak>
        <div class="intro-y col-span-12 2xl:col-span-6 lg:col-span-6">
            <div class="box" v-if="allSectors.length === 0">
                <div v-if="isDataLoading">
                    <x-dom-loader></x-dom-loader>
                </div>
                <div v-else>
                    <x-empty-state message="Aucun secteur disponible."></x-empty-state>
                </div>
            </div>
            <div v-else>
                <div class="box">
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="" v-for="(data, index) in allSectors" :key="index">
                                    ...
                                    <td class="px-5 py-3 border-b w-32 text-right font-medium dark:border-darkmode-400">
                                        <div class="flex items-center font-medium">
                                            ...
                                            <button @click="deleteSector(data)" class="text-danger border border-slate-200 ml-1 rounded-lg px-2 py-2 text-sm hover:bg-red-200 hover:border-red-400">
                ...
                <div class="col-span-12">
                    ...
                    <div class="intro-x box">
                        ...
                        <div class="p-5">
                            ...
                            <form class="preview form-horaire relative [&.hide]:overflow-hidden [&.hide]:h-0" method="POST" @submit.prevent="createSector">
                                <div>
        ...
        <div id="success-notification-content" class="py-5 pl-5 pr-14 bg-white border border-slate-200/60 rounded-lg shadow-xl dark:bg-darkmode-600 dark:text-slate-300 dark:border-darkmode-600 hidden flex">
            ...
            <div class="ml-4 mr-4">
                ...
                <div class="text-slate-500 mt-1">La création du secteur est effectuée ! </div>
            </div>
        </div>
    </div>
