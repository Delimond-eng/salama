        ...
        allRequests(){
            if(this.filter_date || this.search){
               if(this.filter_date){
                   ...
                   return this.requests.filter((el) => {
                       return el.agent.fullname.toLowerCase().includes(this.search.toLowerCase())
                           || el.agent.matricule.toLowerCase().includes(this.search.toLowerCase());
                   });
               }
            }
            else{
