(() => {
    (async function () {
        "use strict";
        let o = await axios.get("https://dummy-wrvf.vercel.app/location.json");
        $(".leaflet").each(async function () {
            ...
            if (e) {
                ...
                let n = L.markerClusterGroup({
                    maxClusterRadius: 30,
                    iconCreateFunction: function (t) {
                        let a = $("html").hasClass("dark")
                ...
                o.data.map(function (t) {
                    let a = L.marker(
                        ...
                        },
                        {
                            title: t.name,
                            icon: L.icon({
                                iconUrl: `data:image/svg+xml;base64,${i}`,
